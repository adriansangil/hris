						...
						<div class="panel panel-default">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="text-center">
										...
										echo form_open(base_url().'index.php/my_leave/my_leave_summary',$attributes); ?>
							...
							<div class="panel-body">
								<table class="table table-striped table-bordered table-condensed table-hover">
									...
									<tr  class="success">
										<th>TOTAL</th>
										<td><div class="text-center"><?php echo $total_vacation_leave; ?> / <?php echo $current_vacation_leave_settings['max_leave']; ?></div></td>
										<td><div class="text-center"><?php echo $lwop_vacation; ?></div></td>
										<td><div class="text-center"><?php echo $total_sick_leave; ?> / <?php echo $current_sick_leave_settings['max_leave']; ?></div></td>
