								...
								<table class="table table-condensed table-hover">
									<thead>
										...
										<tr>
											...
											<td><a href="<?php echo base_url().'index.php/employee/edit_employee/'.$data->employee_id ?>"><span class="glyphicon glyphicon-edit"></span><small> Edit</small></a></td>
											<td><a href="<?php echo base_url().'index.php/employee/delete_employee/'.$data->employee_id ?>" onclick="return confirm('Remove this employee?');"><span class="glyphicon glyphicon-trash"></span><small> Delete</small></a></td>
										</tr>
										<?php endforeach ?>
