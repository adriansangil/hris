								...
								<table class="table table-striped table-bordered table-condensed table-hover">
									...
									<tr>
										...
										<td><div class="text-center"><?php echo $summary['vl'];?> / 
											<?php foreach($all_base_leave as $base_leave):
											if($summary['vl_base_id']==$base_leave['base_leave_id'])
												{
													echo $base_leave['max_leave'];
												}
											endforeach?></div></td>
										<td><div class="text-center"><?php echo $summary['vl_lwop'];?></div></td>
										<td><div class="text-center"><?php echo $summary['sl'];?> /
										<?php foreach($all_base_leave as $base_leave):
											if($summary['sl_base_id']==$base_leave['base_leave_id'])
												{
													echo $base_leave['max_leave'];
												}
											endforeach?></div></td>
