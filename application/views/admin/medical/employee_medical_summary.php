		...
		<div class="panel panel-default">
			...
			<div class="panel-body" style="background-color:#f7f7f7">
				<div class="well well-sm">
					* Eligible for P <?php echo number_format((float)$medical_settings['max_benefit'], 2, '.', ','); ?> amount of Medical Assistance Benefit. 
				</div>	
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
									...
									<div class="col-md-10">
										<table class="table table-striped table-bordered table-condensed table-hover">
											...
											<tr  class="success">
												<th>TOTAL</th>
												<td></td>
												<td><div class="text-center"><?php echo number_format((float)$total_benefits, 2, '.', ','); ?> / <?php echo number_format((float)$medical_settings['max_benefit'], 2, '.', ','); ?></div></td>
