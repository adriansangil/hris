		...
		<div class="panel panel-default">
			<div class="panel-heading" style="background-color:#56b4d0; color: #fff;">
				<div class="row">
					...
					<div class="col-md-2"><div class="text-right">Status: <?php echo  $past_medical_settings['employee_status'] ?></div>
					</div>
				</div>
			</div>	
			<div class="panel-body" style="background-color:#f7f7f7">
				<div class="well well-sm">
					* Eligible for P <?php echo number_format((float)$past_medical_settings['max_benefit'], 2, '.', ','); ?> amount of Medical Assistance Benefit. 
				</div>	
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="text-center">
										...
										echo form_open(base_url().'index.php/medical/employee_medical_summary/'.$id,$attributes); ?>
									...
									<div class="col-md-8">
										<table class="table table-striped table-bordered table-condensed table-hover">
											...
											<tr  class="success">
												<th>TOTAL</th>
												<td></td>
												<td><div class="text-center"><?php echo number_format((float)$total_benefits, 2, '.', ','); ?> / <?php echo number_format((float)$past_medical_settings['max_benefit'], 2, '.', ','); ?></div></td>
