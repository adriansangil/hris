							...
							<div class="panel-body">
								<table class="table table-striped table-bordered table-condensed table-hover">
									<tr>
										...
										<th colspan="2" width="40%"><div class="text-center">MEDICAL ASSISTANCE BENEFIT</div></th>
									</tr>
									<tr>
										<th width="20%"><div class="text-center">Availed / Max</div></th>
										<th width="20%"><div class="text-center">Balance</div></th>
									...
									<tr>
										...
										<td><div class="text-center"><?php echo number_format((float)$summary['benefit_consumed'], 2, '.', ',');?> / 
											...
											if($summary['base_benefit_id']==$benefit['base_benefit_id'])
												{ 
