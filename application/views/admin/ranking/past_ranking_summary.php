				...
				<div class="row">
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading" style="background-color:#f79f1f; color:#fff;">
								<div class="row">
									<div class="col-md-5">Ranking Date: <?php if(count($rank_date) == 0){
										echo 'None';
									}
									else{
										echo date('l jS \of F Y', strtotime($rank_date['rank_date']));
									} ?>
									</div>
									<div class="col-md-3">
									</div>
							...
							<div class="panel-body">
								<table class="table table-striped table-bordered table-condensed table-hover">
									...
									<tr>
										<td><div class="text-center"><a href="<?php echo base_url().'index.php/ranking/employee_ranking/'.$summary['employee_id']; ?>"><?php echo $summary['first_name'].' '.$summary['last_name']; ?></a></div></td>
