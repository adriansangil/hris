							...
							<div class="panel-body">
								...
								<thead>
									...
									<tr>
										<td width="20%"> Type</td>
										<td style="color: #88919a"> <?php 
											if($admin_details['employee_type']==null){
												echo 'No employee type added.';
											}
											else{
												echo $admin_details['employee_type'];
											} ?></td>
										<td width="10%"><div class="text-center"> <a href="" data-toggle="modal" data-target="#myModaledit4"><small><span class="glyphicon glyphicon-edit"></span> Edit</small></a></div>
											<div class="modal fade" id="myModaledit4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
												<div class="modal-dialog">
													<div class="modal-content">
														<?php $attributes = array('class' => 'form-horizontal', 'role' => 'form');
														echo form_open('settings',$attributes) ?>
