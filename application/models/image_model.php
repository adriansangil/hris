...
class Image_model extends CI_Model {
	...
	function do_upload($employee_id){
		...
		if ( ! $this->upload->do_upload())
		{
			...
			$this->session->set_flashdata('msg1', 'Upload Failed! Only jpg,jpeg,png,gif image format can be uploaded.');
		...
		else
		{
			...
			redirect(base_url().'index.php/employee/view/'.$employee_id,'refresh');
		}
	}
}